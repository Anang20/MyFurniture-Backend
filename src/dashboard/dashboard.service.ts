...
export class DashboardService {
  ...
  async getDataTransaksi() {
    ...
    return {
      Now: {
        Januari: Januari.length,
        Februari: Februari.length,
        Maret: Maret.length,
        April: April.length,
        Mei: Mei.length,
        Juni: Juni.length,
        Juli: Juli.length,
        Agustus: Agustus.length,
        September: September.length,
        Oktober: Oktober.length,
        November: November.length,
        Desember: Desember.length,
      },
      Old: {
        JanuariOld: Januari.length,
        FebruariOld: Februari.length,
        MaretOld: Maret.length,
        AprilOld: April.length,
        MeiOld: Mei.length,
        JuniOld: Juni.length,
        JuliOld: Juli.length,
        AgustusOld: Agustus.length,
        SeptemberOld: September.length,
        OktoberOld: Oktober.length,
        NovemberOld: November.length,
        DesemberOld: Desember.length,
      },
    };
  }
