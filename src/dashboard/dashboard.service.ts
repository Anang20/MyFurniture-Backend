...
export class DashboardService {
  ...
  async getDataTransaksi() {
    ...
    return {
      Now: {
        Januari: Januari.length + 1 || 0,
        Februari: Februari.length + 1 || 0,
        Maret: Maret.length + 1 || 0,
        April: April.length + 1 || 0,
        Mei: Mei.length + 1 || 0,
        Juni: Juni.length + 1 || 0,
        Juli: Juli.length + 1 || 0,
        Agustus: Agustus.length + 1 || 0,
        September: September.length + 1 || 0,
        Oktober: Oktober.length + 1 || 0,
        November: November.length + 1 || 0,
        Desember: Desember.length + 1 || 0,
      },
      Old: {
        JanuariOld: Januari.length + 1 || 0,
        FebruariOld: Februari.length + 1 || 0,
        MaretOld: Maret.length + 1 || 0,
        AprilOld: April.length + 1 || 0,
        MeiOld: Mei.length + 1 || 0,
        JuniOld: Juni.length + 1 || 0,
        JuliOld: Juli.length + 1 || 0,
        AgustusOld: Agustus.length + 1 || 0,
        SeptemberOld: September.length + 1 || 0,
        OktoberOld: Oktober.length + 1 || 0,
        NovemberOld: November.length + 1 || 0,
        DesemberOld: Desember.length + 1 || 0,
      },
    };
  }
